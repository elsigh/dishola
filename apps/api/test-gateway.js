...
async function testGateway() {
  ...
  try {
    ...
    if (error.message.includes("authentication") || error.message.includes("401")) {
      ...
      console.debug("1. For local development: Run `vc env pull` to get authentication token")
      console.debug("2. For production: Deploy to Vercel for automatic authentication")
      console.debug("3. Make sure you have the Vercel CLI installed: `npm i -g vercel`")
    }
  }
}
