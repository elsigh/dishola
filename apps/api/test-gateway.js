...
async function testGateway() {
  ...
  try {
    ...
    if (error.message.includes('authentication') || error.message.includes('401')) {
      ...
      console.log('1. For local development: Run `vc env pull` to get authentication token');
      console.log('2. For production: Deploy to Vercel for automatic authentication');
      console.log('3. Make sure you have the Vercel CLI installed: `npm i -g vercel`');
    }
  }
}
