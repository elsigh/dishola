...
export default function HomePage() {
  ...
  useEffect(() => {
    // Wait for auth loading to complete, user to exist, location to be available, and profile to be loaded
    if (!authLoading && user && latitude !== null && longitude !== null && profile !== null) {
  ...
  }, [user, authLoading, latitude, longitude, getUserTastes, profile, router])
