	...
	const mockDishes = [
		{
			...
			imageUrl: `/img/placeholder.svg?width=300&height=200&query=${encodeURIComponent(q || "food")}`,
			rating: 4.5,
		...
		},
		{
			...
			imageUrl: `/img/placeholder.svg?width=300&height=200&query=authentic+${encodeURIComponent(q || "dish")}`,
			rating: 4.8,
		...
		},
		{
			...
			imageUrl: `/img/placeholder.svg?width=300&height=200&query=gourmet+${encodeURIComponent(q || "meal")}`,
			rating: 4.2,
