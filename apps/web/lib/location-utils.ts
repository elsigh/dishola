...
export function getNeighborhoodFallback(lat: number, lng: number): LocationInfo {
  ...
  const sfNeighborhoods = [
    ...
    { name: "Outer Richmond", bounds: { minLat: 37.765, maxLat: 37.785, minLng: -122.51, maxLng: -122.485 } },
    { name: "Richmond", bounds: { minLat: 37.765, maxLat: 37.785, minLng: -122.485, maxLng: -122.47 } },
    { name: "Inner Richmond", bounds: { minLat: 37.765, maxLat: 37.785, minLng: -122.47, maxLng: -122.46 } },
 ...
 */
const US_CITIES = [
  { name: "New York", state: "NY", bounds: { minLat: 40.477, maxLat: 40.917, minLng: -74.259, maxLng: -73.7 } },
  { name: "Los Angeles", state: "CA", bounds: { minLat: 33.704, maxLat: 34.337, minLng: -118.668, maxLng: -118.155 } },
  { name: "Chicago", state: "IL", bounds: { minLat: 41.644, maxLat: 42.023, minLng: -87.94, maxLng: -87.524 } },
  { name: "Houston", state: "TX", bounds: { minLat: 29.523, maxLat: 30.11, minLng: -95.823, maxLng: -95.069 } },
  { name: "Phoenix", state: "AZ", bounds: { minLat: 33.295, maxLat: 33.745, minLng: -112.372, maxLng: -111.933 } },
  { name: "Philadelphia", state: "PA", bounds: { minLat: 39.867, maxLat: 40.138, minLng: -75.28, maxLng: -74.956 } },
  { name: "San Antonio", state: "TX", bounds: { minLat: 29.213, maxLat: 29.699, minLng: -98.83, maxLng: -98.307 } },
  ...
  { name: "San Jose", state: "CA", bounds: { minLat: 37.209, maxLat: 37.469, minLng: -122.06, maxLng: -121.693 } },
  ...
  { name: "Columbus", state: "OH", bounds: { minLat: 39.886, maxLat: 40.157, minLng: -83.188, maxLng: -82.799 } },
  {
    name: "San Francisco",
    state: "CA",
    bounds: { minLat: 37.708, maxLat: 37.833, minLng: -122.515, maxLng: -122.357 }
  },
  { name: "Charlotte", state: "NC", bounds: { minLat: 35.095, maxLat: 35.37, minLng: -80.967, maxLng: -80.648 } },
  ...
  { name: "Denver", state: "CO", bounds: { minLat: 39.614, maxLat: 39.914, minLng: -105.11, maxLng: -104.601 } },
  { name: "Washington", state: "DC", bounds: { minLat: 38.791, maxLat: 38.996, minLng: -77.119, maxLng: -76.91 } },
  ...
  { name: "Boston", state: "MA", bounds: { minLat: 42.228, maxLat: 42.4, minLng: -71.191, maxLng: -70.986 } },
  { name: "Portland", state: "OR", bounds: { minLat: 45.421, maxLat: 45.65, minLng: -122.849, maxLng: -122.471 } },
  { name: "Las Vegas", state: "NV", bounds: { minLat: 35.96, maxLat: 36.341, minLng: -115.373, maxLng: -114.982 } },
  { name: "Detroit", state: "MI", bounds: { minLat: 42.255, maxLat: 42.45, minLng: -83.287, maxLng: -82.91 } },
  { name: "Memphis", state: "TN", bounds: { minLat: 34.987, maxLat: 35.261, minLng: -90.31, maxLng: -89.643 } },
  ...
  { name: "Albuquerque", state: "NM", bounds: { minLat: 35.005, maxLat: 35.31, minLng: -106.815, maxLng: -106.448 } },
  ...
  { name: "Atlanta", state: "GA", bounds: { minLat: 33.649, maxLat: 33.887, minLng: -84.552, maxLng: -84.29 } },
  { name: "Kansas City", state: "MO", bounds: { minLat: 39.011, maxLat: 39.201, minLng: -94.752, maxLng: -94.48 } },
  {
    name: "Colorado Springs",
    state: "CO",
    bounds: { minLat: 38.701, maxLat: 38.936, minLng: -104.874, maxLng: -104.609 }
  },
  { name: "Miami", state: "FL", bounds: { minLat: 25.7, maxLat: 25.855, minLng: -80.313, maxLng: -80.134 } },
  { name: "Raleigh", state: "NC", bounds: { minLat: 35.731, maxLat: 35.877, minLng: -78.721, maxLng: -78.542 } },
  { name: "Omaha", state: "NE", bounds: { minLat: 41.214, maxLat: 41.372, minLng: -96.19, maxLng: -95.865 } },
  { name: "Long Beach", state: "CA", bounds: { minLat: 33.748, maxLat: 33.885, minLng: -118.25, maxLng: -118.063 } },
  ...
  { name: "Minneapolis", state: "MN", bounds: { minLat: 44.89, maxLat: 45.051, minLng: -93.329, maxLng: -93.193 } },
  { name: "Tulsa", state: "OK", bounds: { minLat: 36.066, maxLat: 36.23, minLng: -96.025, maxLng: -95.865 } },
  { name: "Tampa", state: "FL", bounds: { minLat: 27.877, maxLat: 28.016, minLng: -82.638, maxLng: -82.394 } },
  { name: "Arlington", state: "TX", bounds: { minLat: 32.653, maxLat: 32.787, minLng: -97.222, maxLng: -97.03 } },
  { name: "New Orleans", state: "LA", bounds: { minLat: 29.867, maxLat: 30.199, minLng: -90.14, maxLng: -89.625 } }
]
