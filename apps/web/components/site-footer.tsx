			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-brand-text-muted">
				<div className="mt-2 text-xs flex flex-col items-center">
					<ul className="mt-1 text-left mx-auto max-w-xs">
						<li>[dish-ola]</li>
						<li className="mb-1">
							<span className="font-bold">v.</span> To share the love of food –
							dish by dish.
						</li>
						<li>
							<span className="font-bold">n.</span> The ultimate source to find
							real meals at real places that rule.
						</li>
					</ul>
				</div>
				<div className="mt-4 flex justify-center gap-4 text-xs">
					...
					<span>
						&copy; {new Date().getFullYear()} dishola. All rights reserved.
					</span>
				</div>
			</div>
		</footer>
